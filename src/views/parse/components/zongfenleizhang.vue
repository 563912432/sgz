  ...
  <div class="Parsezongfenleizhang flex">
    <div v-if="leftShow" class="flex-1" style="overflow-x: auto">
      <div class="mb-12 flex flex-justify-space-between pl-10 pr-10">
        <span>
          ...
          <el-button plain size="small" @click="keMuHuiZongMyAnswer">科目汇总表</el-button>
        </span>
        <span>
    ...
    <div v-if="rightShow" class="flex-1" style="overflow-x: auto">
      <div class="mb-12 flex flex-justify-space-between pl-10 pr-10">
        <span>
          <el-button plain size="small" @click="qiChuMyAnswer">期初余额</el-button>
          <el-button plain size="small" @click="keMuHuiZongRightAnswer">科目汇总表</el-button>
        </span>
        <span>
...
export default {
  ...
  methods: {
    ...
    keMuHuiZongMyAnswer () {
      this.$emit('clickKeMuHuiZongMyAnswer')
    },
    keMuHuiZongRightAnswer () {
      this.$emit('clickKeMuHuiZongRightAnswer')
    }
  }
}
</script>
