<template>
  <div class="ParseReferJiZhang flex flex-column">
...
export default {
  ...
  methods: {
    ...
    initAnswer () {
      // 答案
      if (this.type === 1) {
        this.jiZhangAnswer = this.$store.state.record['pingZheng']
      } else {
        this.jiZhangAnswer = this.$store.state.answer['pingZheng']
      }
...
<style>
  .ParseReferJiZhang .el-input.is-disabled .el-input__inner{
    background-color: transparent;
    border-color: #E4E7ED;
    color: #C0C4CC;
  }
  .ParseReferJiZhang .table .el-input.is-disabled .el-input__inner{
    background-color: transparent;
    border: none;
    /*border-color: #E4E7ED;*/
    /*color: #C0C4CC;*/
