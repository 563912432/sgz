<template>
  <div class="ParseReferkeMuHuiZong">
...
export default {
  ...
  created () {
    let answer = {}
    if (this.type === 1) {
      answer = this.$store.state['record']['keMuHuiZong']
    } else {
      answer = this.$store.state['answer']['keMuHuiZong']
    }
