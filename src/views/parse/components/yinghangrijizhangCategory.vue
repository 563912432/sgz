<template>
  <div class="ParseyinHangRiJiZhangCatalog">
    <div class="title">
    ...
    <div class="content">
      ...
      <div class="content-header flex">
        ...
        <div class="w-60 border-bottom-grey flex flex-align-center flex-justify-center bold">查看账页</div>
      </div>
      <div class="content-table-yinhang-rijizhang">
        <div v-for="(item, index) in answer" :key="index" class="flex h-50 position-relative" :class="index + 1 === active?'bg-green':''">
          ...
          <div class="w-96 border-right-bottom-grey flex flex-align-center flex-justify-center bold">
            <el-input v-model="item.page" size="small" readonly type="text" maxlength="2" class="ml-5 mr-5"></el-input>
          </div>
          <div class="w-60 border-bottom-grey flex flex-align-center flex-justify-center bold">
...
<script>
export default {
  name: 'ParseyinHangRiJiZhangCatalog',
  data () {
    return {
      active: 0
    }
...
<style>
  ...
  .ParseyinHangRiJiZhangCatalog .el-input.is-disabled .el-input__inner{
    background-color: transparent;
  }
</style>
<style lang="scss" scoped>
  .ParseyinHangRiJiZhangCatalog{
    width: 100%;
    margin: 0 auto;
    color: #333333;
    padding-top: 10px;
