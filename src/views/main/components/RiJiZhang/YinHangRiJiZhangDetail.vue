<template>
  <div class="yinhangRiJiZhangDetail">
    <div class="title">
      <span>银行存款日记账</span>
...
export default {
    ...
    return {
      initData: {
        ...
        table: [
          ...
          { month: '', day: '', zi: '', hao: '', zhai_yao: '', state: '', jie_money: '', dai_money: '', jie_huo_dai: '', yu_e: '' },
          { month: '', day: '', zi: '', hao: '', zhai_yao: '', state: '', jie_money: '', dai_money: '', jie_huo_dai: '', yu_e: '' }
        ]
      },
      active: 0
  ...
  methods: {
    ...
    saveChildAnswer () {
      const answer = this.$store.state.answer['riJiZhang'][1]['answer']
      answer[this.subjectIndex]['info'] = this.initData
      this.$store.commit('SAVE_YIN_HANG_RI_JI_ZHANG_ANSWER', answer)
